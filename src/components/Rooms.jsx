...
import {
  Wifi, Wind, Tv, Coffee, Droplets, Users, Maximize2,
...
const rooms = [
  ...
  },
  {
    ...
    image: roomFamily,
    amenities: ['AC', 'WiFi', 'Smart TV', 'Sarapan', 'Bathtub', 'Minibar', 'Living Area', 'Kitchenette'],
    description: 'Kamar keluarga terluas kami dengan ruang hidup yang nyaman. Dilengkapi tempat tidur king dan twin, sempurna untuk keluarga yang menginginkan pengalaman terbaik.',
  },
];
        ...
        >
          ...
          <div className="p-6 md:p-8">
            <div className="flex items-center gap-2 mb-2">
              <span className={`${typeBadgeColors[room.type]} text-white text-xs font-bold px-3 py-1 rounded-lg`}>
                {room.type}
              </span>
              {room.originalPrice > room.price && (
            ...
            <h4 className="font-semibold text-slate-800 mb-3">Fasilitas Kamar</h4>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="section-subtitle mt-4">
              ...
              fasilitas modern dan sarapan pagi.
            </p>
          </motion.div>
